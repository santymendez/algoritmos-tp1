...
int main(){
    ...
    int prodmax[ncli]{}; //tipo de productos entregados con mas de 13.000 kg por cliente.
    float km_prod[nprod]{}; //kilometros recorridos por tipo de producto.
    ...
    while(archi >> client >> prod >> kg >> km){
        ...
        if(productos[prod] == "Textiles"){  //cuenta las entregas de productos textiles que se hicieron.
            cont++;
        }
    }
    ...
    for(int i = 0; i < ncli; i++){                  //for para recorrer la matriz
        flag = true;  
    ...
    for(int i = 0; i < nprod; i++){  //vector de posiciones.
        vpos[i] = i;
    }
    ...
    cout << "Cantidad de entregas para el tipo de producto Textiles: " << cont << endl;
